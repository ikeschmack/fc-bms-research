...
# Drop values if they are in df_wne_filtered['sub_job_id'].values
df_merged = df_merged[~df_merged['sub_job_id'].isin(df_wne_filtered['sub_job_id'].values)]


# Create a scatter plot with histograms using seaborn, x and y are on a log scale
...
#for i, row in df_merged.iterrows():
    #if row['sub_job_id'] not in df_wne_filtered['sub_job_id'].values:
...
# Add a diagonal line (y = x) for perfect correlation
fig.add_shape(
    type='line',
