...
The current method of calculating bandwidth measurements is the following equation:
 ...
 ∑( (total_bytes_n * 8) / (elapsed_seconds_n  * 10242)) across all workers in a sub job
...
This form of bandwidth inflation is the reason why I decided the method of early exit may be beneficial to the accuracy of the download. As the remaining workers continue to download, they pick up the remaining bandwidth leading to the individual worker’s download speed ratio increasing.
